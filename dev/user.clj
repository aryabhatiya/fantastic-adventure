(ns user
  (:require [fantastic-adventure.application]
            ...
            [fantastic-adventure.config :refer [config]]))

(defn dev-system []
  (assoc (fantastic-adventure.application/app-system (config))
    :figwheel-system (fw-sys/figwheel-system (fw-config/fetch-config))
    :css-watcher (fw-sys/css-watcher {:watch-paths ["resources/public/css"]})
    :garden-watcher (new-garden-watcher ['fantastic-adventure.styles])))
